...
* 	2013-06-07 - 3.2.00 - Added documentation for message parts
*
* ====================================================================
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:ws="http://schemas.xmlsoap.org/wsdl/" xmlns:ws2="http://www.w3.org/ns/wsdl" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" version="1.0" exclude-result-prefixes="ws ws2 xsd soap local">
	...
	<xsl:param name="wsdl-viewer.version">3.2.00</xsl:param>
	...
	<xsl:variable name="css">
		...
		*/
		...
		.xml-element, .xml-element a, .xml-proc, .xml-proc a, .xml-comment, .xml-comment a {
		margin: 2px 0;
		padding: 2px 0 2px 0;
		}

		.xml-element, .xml-element a {
		word-spacing: 3px;
		color: red;
		font-weight: bold;
		font-style:normal;
	...
	<xsl:template name="about.detail">
		...
		<div>
			...
			<br/>
			Modified By: <a href="http://rhythmtraffic.com/">Rhythm Engineering</a>
			<br/>
		</div>
	</xsl:template>
